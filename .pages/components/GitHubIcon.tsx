 ...
 * GitHub mark icon.
 *
 * lucide-react removed brand icons (including `Github`) in recent versions, so we
 * provide a self-contained SVG that keeps the same usage/API as the lucide icon
 * (`<Github className="h-5 w-5" />`). It inherits color via `currentColor` and is
 * sized through the `className`/props just like the other icons.
 */
