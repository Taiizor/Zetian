...
config.CustomNamingFunction = (messageId, date) => 
    $"archive/{date:yyyy/MM}/{messageId}.eml";
```
...
.WithS3CompatibleStorage(
    ...
    config =>
    {
        ...
        config.DisableSSL = true; // For local development
    })
```
